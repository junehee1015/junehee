		...
		<div id="outbox">		
			<div id="left">
				...
				<ul id="login_ul">
					...
					<li><a href="../event/event" id="leftNavi3">이벤트</a></li>
					<li><a href="../event/prize" id="leftNavi4">당첨자 발표</a></li>
				</ul>			
...
<script type="text/javascript">
	function login(){
		...
		if(mId==""){
			$('#login_text').text("* 아이디를 입력해주세요.");
			$('#login_text').css("color","#f7703c");
			loginForm.mId.focus();
			return false;
		}
		if(mPw==""){
		...
		$.ajax({
			...
			success:function(data){
				if(data ==""){
					$('#login_text').text("* 아이디 또는 비밀번호가 일치하지 않습니다.");
					$('#login_text').css("color","#f7703c");
					return false;
				}else{
					location.href="login";
			...
			error:function(request,status,error){
				alert('ajax 실패');
							...
							<ul id="login_ul">
								<li><input type="text" name="mId" id="mId" class="loginType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								<li><input type="password" name="mPw" id="mPw" class="passType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>
							<div class="btn"><input type="button" onclick="login()" class="sbtn" value="로그인" style="border:0"></div>
							<br><div><strong><p id="login_text"></p></strong></div>
							<div class="chk"><input type="checkbox" id="idsave"/><label for="idsave">아이디 저장</label></div>
							<div class="point"><p>아이디와 비밀번호를 잊으셨나요?</p><a href="#" class="nbtn">아이디/비밀번호 찾기</a></div>
						</div>
					</div>
					</form>
	...
	<!-- container -->
		...
		<div id="outbox">		
			<div id="left">
				<div id="title2">MEMBERSHIP<span>멤버쉽</span></div>
				<ul id="login_ul">
					<li><a href="logout" id="leftNavi2">로그아웃</a></li>
			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform" id="inform">
							<ul>
								<li><h3>[ ${member.mName} ] 님 환영합니다.</h3></li>
							</ul>
							<div class="point"><a href="logout" class="nbtn">로그아웃</a></div>
						</div>
					</div>
					</form>
...
<c:if test="${member.authority==1 }">
		...
		<div id="outbox">		
			<div id="left">
				...
				<ul id="login_ul">
					<li><a href="logout" id="leftNavi2">로그아웃</a></li>
					<li><a href="../admin/adminMember" id="leftNavi3">회원정보</a></li>
			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform" id="inform">
							<ul>
								<li><h3>관리자 모드 입니다. <br><br> [ ${member.mName} ] 님 환영합니다.</h3></li>
							</ul>
							<div class="point"><a href="logout" class="nbtn">로그아웃</a></div>
						</div>
					</div>
