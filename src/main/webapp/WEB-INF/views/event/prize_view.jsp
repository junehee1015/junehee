				...
				<div id="mypage">
					...
					<div class="viewDivMt">
						<div class="viewHead">
							...
							<div class="data">
								<ul>
									<li>등록일
									<span>
									<fmt:formatDate value="${prize_view.pDate }" pattern="yyyy-MM-dd"/>
									</span>
									</li>
									<li>조회수<span>${prize_view.pHits }</span></li>
								</ul>
							</div>
						</div>
						...
						<div class="viewContents">
							${prize_view.pContent }
							<br>
							<a href="${prize_view.pFile }">당첨자 명단</a>
						</div>
					</div>
					...
					<div class="pnDiv web">
						<table summary="이전다음글을 선택하여 보실 수 있습니다." class="preNext" border="1" cellspacing="0">
							...
							<c:if test="${pNext.prize_id!=null }">
								<tr>
									<th class="pre">NEXT</th>
									<td><a href="prize_view?prize_id=${pNext.prize_id }">${pNext.pTitle }</a></td>
								</tr>
							</c:if>
							<c:if test="${pPrev.prize_id==null }">
								<tr>
							...
							<c:if test="${pPrev.prize_id!=null }">
								<tr>
									<th class="next">PREV</th>
									<td><a href="prize_view?prize_id=${pPrev.prize_id }">${pPrev.pTitle }</a></td>
								</tr>
							</c:if>
							</tbody>
						</table>
